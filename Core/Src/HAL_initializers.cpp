...
/* APB1 timer = 64 MHz
 * TIM3 dictates sampling frequency
 * For 40 kHz sampling we need:
 * 40k = 64 M / (prescaler+1) / (period+1) where
 * prescaler and period are 16 bits (between 0 and 65535)
 *  64 M / 16 = 4 M --> prescaler = 16-1
 *  4 M / 100 = 40 k--> counter = 100-1
 *  */
